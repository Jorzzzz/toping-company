...
if(isset($_POST['Proses']))
	{
		$updatestatus = mysqli_query($conn,"update cart set status='Terproses' where orderid='$orderids'");
...
<head>
    ...
    <title>Toping Company - Pesanan <?php echo $checkdb['namalengkap']; ?></title>
                        ...
                        <ul class="metismenu" id="menu">
							...
							<li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="vendor.php">Jasa</a></li>
                            ...
                            <div class="card-body">
								...
								<p>Waktu order : <?php echo $checkdb['tglorder']; ?></p>
								   ...
								   <div class="data-tables datatable-dark">
									...
									<br><br>
									<form method="post">
									<input type="submit" name="Proses" class="form-control btn btn-success" value="Proses" \>
									</form>
									';
									}
									;
