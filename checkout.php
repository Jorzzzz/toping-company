...
<html>
<head>
<title>Toping Company - Checkout</title>
<!-- for-mobile-apps -->
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di Toping Company</span></h1>
		...
		<br>
		<form method="post">
		<input type="submit" class="form-control btn btn-success" name="checkout" value="Saya Setuju & Bayar" \>
		</form>
